...
- 新しい匿名保有記録の経路は、実際の事前予約・秘密照合・共同証明・DeFMI決済まで接続済みです。ただし、法人の送信キュー、停止後の再送、受領した権利のウォレットへの取り込み、複数約定・取消・期限切れを含む全経路の統合確認は残っています。情報の分離は[予約証明の情報分離](docs/RESERVATION_PRIVACY.md)を参照してください。

...
[DeFMI の接続資料](https://github.com/zkFMI/defmi/blob/3aadc4577129ce74347082347915484764157715/docs/APPLICATION_NOTE_RESERVATIONS_JA.md)
に記載しています。

支出証明は、所有権と金額を別々に拘束する新形式へ変更しています。
旧方式で見つけた金額改ざん、使用元の直接特定、残差検証、出力先差替えの問題は
[DeFMIの安全性レビュー](https://github.com/zkFMI/defmi/blob/3aadc4577129ce74347082347915484764157715/docs/NOTE_PROOF_SECURITY_REVIEW_20260905.md)
